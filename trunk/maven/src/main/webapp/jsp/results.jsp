<%--<!--
 ...
 -->
<%@ page import = "  javax.servlet.*, javax.servlet.http.*, java.io.*, org.apache.lucene.analysis.*, net.paoding.analysis.analyzer.PaodingAnalyzer, org.apache.lucene.document.*, org.apache.lucene.index.*, org.apache.lucene.store.*, org.apache.lucene.search.*, org.apache.lucene.queryParser.*, org.apache.lucene.demo.*, org.apache.lucene.demo.html.Entities, java.net.URLEncoder, org.apache.lucene.util.Version" %>
...
<%
       if (error == false) {                                           //did we open the index?
                queryString =  "经济";//rrequest.getParameter("query");           //get the search criteria
                ...
                Analyzer analyzer = new PaodingAnalyzer();           //construct our usual analyzer
                try {
...
<%
                        ...
                        if ((doctitle == null) || doctitle.equals("")) //use the path if it has no title
                                doctitle = url;
                                                                       //then output!
%>
                        <td><%= hits.scoreDocs[i].score%><a href="<%=url%>"><%=doctitle%></a></td>
                        <td><%=doc.get("modified")%><%=doc.get("contents")%></td>
                </tr>
<%
                }
%>
